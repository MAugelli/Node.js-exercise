...
class Logger {
  ...
  async info(message) { await this.logStorage.write(`[INFO] ${message}\n`) }
  async error(message) { await this.logStorage.write(`[ERROR] ${message}\n`) }
  async replay() { console.log(await this.logStorage.read()) }
}
